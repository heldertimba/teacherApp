			...
			<div class = "row">
				...
				<!-- Vertical form options -->
					<div class="col-md-5">
						...
						<!-- Basic layout-->
						<form action="regclass.php"  method="POST" class="form-horizontal">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title text-bold">New Class</h5>
												...
												<div class="col-lg-9">
														<div class="row">
															...
															<div class="input-group">
																	<select data-placeholder="Select a Class" name="turma" class="select">
																		<option value="A" name="turma">Class A</option>
																		<option value="B" name="turma">Class B</option>
																		<option value="C" name="turma">Class C</option>
																</select>
															</div>
					...
					<div class="col-md-7">
											...
											<div class="panel panel-flat">
												<div class="panel-heading">
													<h5 class="panel-title text-bold">List of Class</h5>
...
if($result = mysqli_query($mysqli, $sql)){
    if(mysqli_num_rows($result) > 0){
        while($row = mysqli_fetch_array($result)){    
				...
				if($row['nome_turma']=="A"){$turma="Class A";}
				if($row['nome_turma']=="B"){$turma="Class B";}
				if($row['nome_turma']=="C"){$turma="Class C";}
				echo "<td>" . $turma . "</td>";
				echo "<td>" . $row['data'] . "</td>";
				echo "<td>" . $row['responsavel'] . "</td>";
				echo "<td class='text-center'>";
				echo "<ul class='icons-list'>";
				echo "<li><a href='removerTurma.php?id_turma=$id'><i class='icon-cancel-circle2'></i></a></li>";
