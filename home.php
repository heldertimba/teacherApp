					...
					<div class="col-md-3">
						<div class="panel">
							<div class="panel-body text-center">
								...
								<?php else:  ?>
								<a href="#"   class="btn bg-purple-400"><?php echo "Service unavailable"; ?></a>
								<?php endif;  ?>
							</div>
						</div>
					</div>
					...
					<div class="col-md-3">
						<div class="panel">
							<div class="panel-body text-center">
								...
								<h5 class="text-semibold">Teacher and Student Pane</h5>
            ...
            <div id="modal_dividas" class="modal fade" >
                <div class="modal-dialog">
                    <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col-xs-6">
									...
									<br>
									 <form method="post" action = "">
                                        <button class="btn bg-danger-400 btn-block btn-float btn-float-lg" type="submit"><i class=""></i> <span class="text-bold text-uppercase"> </br></br></span></button>
                                    </form>
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <form method="post" action = "turma_docente.php">
                                        <button class="btn bg-danger-400 btn-block btn-float btn-float-lg" type="submit"><i class="icon-archive"></i> <span class="text-bold text-uppercase">Allocate Classes</span></button>
                                    </form>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="icon-chevron-down"></i>  Close</button>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <form method="post" action = "login.html">
                                                <button class="btn bg-orange-400 btn-block btn-float btn-float-lg" type="submit"><i class="icon-statistics"></i> <span class="text-bold text-uppercase">Teacher</span></button>
                                            </form>
                                        </div>
                                        ...
                                        <div class="col-xs-6">
                                            <form method="post" action = "login.html">
                                                <button class="btn bg-orange-400 btn-block btn-float btn-float-lg" type="submit"><i class="icon-book3"></i> <span class="text-bold text-uppercase">Student</span></button>
                                            </form>
                                        </div>
