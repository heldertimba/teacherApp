...
$id=$_GET['id_est'];
$sql = "SELECT * FROM estudante WHERE id_est='$id'";
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="thumbnail">
                                        ...
                                        <div class="caption text-center">
                                            <h6 class="text-semibold no-margin"><?php echo  $nome;?> <small class="display-block"><?php ?></small></h6>
                                            <ul class="icons-list mt-15">
                                                <!--<li><a href="<?php ?>" data-popup="tooltip" title="Anexo 1"><i class="icon-attachment"></i></a></li>-->
