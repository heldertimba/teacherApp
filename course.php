...
<body oncontextmenu="return false">
        ...
        <div class="navbar navbar-inverse">
            <div class="navbar-header">
                <h5 class="text-semibold class text-uppercase" style="margin-left: 2em;"> Class Teacher APP </h5>
			...
			<div class = "row">
				...
				<!-- Vertical form options -->
					<div class="col-md-5">
						...
						<!-- Basic layout-->
						<form action="regcurso.php"  method="POST" class="form-horizontal">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title text-bold">Add new Course</h5>
								...
								<div class="panel-body">
										...
										<div class="form-group">
											<label class="col-lg-3 control-label text-bold">Course name: </label>
												...
												<div class="col-lg-9">
														<div class="row">
															...
															<div class="input-group col-md-10">
																...
																<input type="text" name="curso" class="form-control" placeholder="Course name ... "/required>
															</div>
										...
										<div class="form-group">
											<label class="col-lg-3 control-label text-bold">Duration: </label>
												...
												<div class="col-lg-9">
														<div class="row">
															...
															<div class="input-group col-md-5">
																...
																<input type="text" class="form-control" name="duracao" placeholder="Duration"/required>
															</div>
					...
					<div class="col-md-7">
											...
											<div class="panel panel-flat">
												<div class="panel-heading">
													<h5 class="panel-title text-bold">List of Course</h5>
													<div class="heading-elements">
														<ul class="icons-list">
