			...
			<div class = "row">
				...
				<!-- Vertical form options -->
					<div class="col-md-5">
						...
						<!-- Basic layout-->
						<form action="regSubjects.php"  method="POST" class="form-horizontal">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h5 class="panel-title text-bold">New subject</h5>
								...
								<div class="form-group">
												...
												<div class="col-lg-9">
														<div class="row">
															...
															<div class="input-group col-md-10">
																...
																<input type="text" name="disc" class="form-control" placeholder="Nome da Disciplina ... " required>
															</div>
										...
										<div class="form-group">
											<label class="col-lg-3 control-label text-bold">Year: </label>
														...
														<div class="row">
															...
															<div class="input-group">
																	<select data-placeholder="Selecione a área de formação" name="ano" class="select">
																		...
																		<option value="1" name="ano">1º</option>
																		<option value="2" name="ano">2º</option>
																		<option value="3" name="ano">3º</option>
																		<option value="4" name="ano">4º</option>
																		<option value="5" name="ano">5º</option>
																</select>
															</div>
												...
												<div class="form-group">
											<label class="col-lg-3 control-label text-bold">Semester: </label>
														...
														<div class="row">
															...
															<div class="input-group">
																	<select data-placeholder="Selecione a área de formação" name="sem" class="select">
																		<option value="1" name="sem">1º</option>
																		<option value="2" name="sem">2º</option>
																</select>
															</div>
					...
					<div class="col-md-7">
											...
											<div class="panel panel-flat">
												<div class="panel-heading">
													<h5 class="panel-title text-bold">List of Subjects </h5>
													<div class="heading-elements">
														<ul class="icons-list">
